...
(function ($, window, document, undefined) {
  ...
  let defaults = {
    ...
    itemRenderer(item_attrs, content, children, options, item, itemParent) {
      ...
      // branchRightBtns
      if ((item.type == 'branch' || item.children) && options.branchRightBtns &&
      ...
      // leafRightBtns
      if ((item.type == 'leaf' || (!item.type && !item.children)) && options.leafRightBtns &&
  ...
  Plugin.prototype = {
    ...
    init() {
      ...
      list.el.on('click', '.branchRightBtn', function (e) {
        ...
        list.options.branchRightBtns.btnGroup[action].onclick.call(list, item, promise);
      });
      ...
      list.el.on('click', '.leafRightBtn', function (e) {
        ...
        list.options.leafRightBtns.btnGroup[action].onclick.call(list, item, promise);
      });
    ...
    asNestedSet() {
      ...
      function traverse(item, depth, lft) {
        ...
        if (id) {
          ret.push({ id, parent_id: pid, depth, lft, rgt });
        }
